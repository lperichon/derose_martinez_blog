<?php
/**
 * Makes a custom Widget for displaying Aside, Link, Status, and Quote Posts available with SwáSthya en Martinez
 *
...
class Twenty_Eleven_Ephemera_Widget extends WP_Widget {
	...
	function Twenty_Eleven_Ephemera_Widget() {
		...
		$this->WP_Widget( 'widget_twentyeleven_ephemera', __( 'SwáSthya en Martinez Ephemera', 'twentyeleven' ), $widget_ops );
