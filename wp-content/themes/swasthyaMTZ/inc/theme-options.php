<?php
/**
 * SwáSthya en Martinez Theme Options
 *
 * @package WordPress
...
function twentyeleven_theme_options_add_page() {
	...
	$help = '<p>' . __( 'Some themes provide customization options that are grouped together on a Theme Options screen. If you change themes, options may change or disappear, as they are theme-specific. Your current theme, SwáSthya en Martinez, provides the following Theme Options:', 'twentyeleven' ) . '</p>' .
			'<ol>' .
...
/**
 * Returns an array of color schemes registered for SwáSthya en Martinez.
 *
 * @since SwáSthya en Martinez 1.0
 */
...
/**
 * Returns an array of layout options registered for SwáSthya en Martinez.
 *
 * @since SwáSthya en Martinez 1.0
 */
...
/**
 * Returns the default options for SwáSthya en Martinez.
 *
 * @since SwáSthya en Martinez 1.0
 */
...
/**
 * Returns the default link color for SwáSthya en Martinez, based on color scheme.
 *
 * @since SwáSthya en Martinez 1.0
 *
...
/**
 * Returns the options array for SwáSthya en Martinez.
 *
 * @since SwáSthya en Martinez 1.0
 */
 ...
 * Returns the options array for SwáSthya en Martinez.
 *
 * @since SwáSthya en Martinez 1.2
 */
...
/**
 * Adds SwáSthya en Martinez layout classes to the array of body classes.
 *
 * @since SwáSthya en Martinez 1.0
 */
